		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapktdemopiechart2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktdemopiechart2-display": {
								"semanticObject": "sapktdemopiechart2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.demo.piechart2",
									"url": sap.ui.require.toUrl("sap/kt/demo/piechart2")
								}
							}
						}
					}
